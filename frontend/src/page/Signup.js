        ...
        <div className='w-full max-w-sm bg-white m-auto flex flex-col p-4'>
            ...
            <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
                ...
                <input
                    ...
                    id="firstName"
                    name='firstName'
                    className='mt-1 mb-2 w-full bg-slate-200 p-2 py-1 rounded focus-within:outline-blue-300'
                ...
                <div className='flex p-2 py-1 bg-slate-200 rounded mt-1 mb-2 focus-within:outline focus-within:outline-blue-300'>
                    <input
